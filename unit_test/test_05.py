...
class TestVehicleService(unittest.TestCase):
    ...
    def test_get_all_vehicles(self, mock_get_conn):
        ...
        mock_cursor.fetchall.return_value = [
            {'VehicleID': 1, 'Model': 'Sedan', 'Make': 'Toyota', 'Year': 2022, 'Color': 'Blue', 'RegistrationNumber': 'ABC123', 'Availability': 1, 'DailyRate': 50.00},
            {'VehicleID': 2, 'Model': 'SUV', 'Make': 'Honda', 'Year': 2023, 'Color': 'Red', 'RegistrationNumber': 'XYZ456', 'Availability': 1, 'DailyRate': 60.00},
        ]
